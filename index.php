...
if ($_GET ) :                           
    ...
    }elseif($_GET["pendaftaran"] == "ulang"){       
      header("location: pendaftaran-ulang");
      exit; 
    }
    ...
    elseif(isset($_GET["pasca"])){       
      header("location: pasca-sarjana");
      exit; 
    }

    elseif(isset($_GET["beasiswa"])){       
      header("location: beasiswa");
      exit; 
    }

    elseif(isset($_GET["alih"])){       
