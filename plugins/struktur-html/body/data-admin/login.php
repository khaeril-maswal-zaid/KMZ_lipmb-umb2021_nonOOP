<main> 
<!-- Tutupnya ada di navbar admin -->

<form class="form-signin" action="../plugins/configurasi/proses-admin.php"	 method="post">
  <div class="text-center mb-4">
    <img class="mb-4 mt-1" src="../plugins/assets/image/umb.png" alt="" width="72" height="72">
    <h1 class="h3 mb-2 font-weight-normal">Login Admin SIM-LIPMB</h1>
  ...
  <button name="login-admin" class="btn btn-lg btn-primary btn-block" type="submit">Sign in</button></p>
</form>

<!-- Footer sudah bawaan dari admin -->